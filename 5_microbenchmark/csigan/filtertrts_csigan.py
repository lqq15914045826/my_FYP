...
def main(args):
    ...
    model = train(args, labeled_dataset, unlabeled_real_dataset, None, test_loader, 
        model, generator, optimizer_dis, optimizer_gen, scheduler_dis, scheduler_gen, 
        device, logger, writer)
...
if __name__ == '__main__':
    ...
    # log parameters
    parser.add_argument('--log_dir', type=str, default='./csigan_filtertrts_logs', help='path to log directory')
    parser.add_argument('--checkpoint_root_dir', type=str, default='./csigan_filtertrts_checkpoints', help='path to checkpoint directory')
