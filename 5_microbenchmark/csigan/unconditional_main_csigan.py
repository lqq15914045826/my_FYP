...
def main(args):
    ...
    model = Discriminator_syncheck(
        category=args.num_classes, mid_channels=args.mid_channels, seed=args.seed
    )
    model.to(device)
    ...
    unlabeled_syn_dataset = SignFiCSIDataset(
        ...
        "unconditional_cycle_target_all_syn_csi",
        "unconditional_cycle_target_all_syn_label",
        args.normalize_csi,
        syn_transform,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--syn_dataset_dir",
        type=str,
        default="unconditional_synthetic_data",
        help="path to original data",
    )
    ...
    parser.add_argument(
        "--log_dir",
        type=str,
        default="./unconditional_csigan_syncheck_logs",
        help="path to log directory",
    )
    parser.add_argument(
        "--checkpoint_root_dir",
        type=str,
        default="./unconditional_csigan_syncheck_checkpoints",
