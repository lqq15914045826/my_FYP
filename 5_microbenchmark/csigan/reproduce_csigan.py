...
if __name__ == '__main__':
    ...
    # log parameters
    parser.add_argument('--log_dir', type=str, default='./csigan_reproduce_logs', help='path to log directory')
    parser.add_argument('--checkpoint_root_dir', type=str, default='./csigan_reproduce_checkpoints', help='path to checkpoint directory')
