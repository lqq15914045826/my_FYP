...
def main(args):
    ...
    if args.syn_ratio != 1.0:
        ...
        selected_syn_cnt = int(
            args.syn_ratio * len(syn_dataset) / 5
        )  # 5 is because original synthetic data is 5 times real data
    ...
    logger.info(
        f"Select {len(syn_dataset)} synthetic data with ssim threshold {args.ssim_threshold}"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="ssim threshold for filtering synthetic data",
    )
    ...
    parser.add_argument(
        "--log_dir",
        type=str,
        default="./csigan_filterssim_logs",
        help="path to log directory",
    )
    parser.add_argument(
        "--checkpoint_root_dir",
        type=str,
        default="./csigan_filterssim_checkpoints",
