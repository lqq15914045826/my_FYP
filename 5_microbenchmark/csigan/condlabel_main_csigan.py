...
def main(args):
    ...
    checkpoint_dir = os.path.join(args.checkpoint_root_dir, \
        f'condlabel-{ablation_name}-{seed_name}-{data_name}-{model_name}-{threshold_name}-{temp_name}-{CURRENT_TIME}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--syn_dataset_dir', type=str, default='../../0_real_data_preparation/csigan_data', help='path to original data')
    ...
    # log parameters
    parser.add_argument('--log_dir', type=str, default='./condlabel_csigan_syncheck_logs', help='path to log directory')
    parser.add_argument('--checkpoint_root_dir', type=str, default='./condlabel_csigan_syncheck_checkpoints', help='path to checkpoint directory')
