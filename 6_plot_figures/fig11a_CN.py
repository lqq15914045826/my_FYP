...
for channel_cnt in [64, 256]:
    ckpt_root_dir = os.path.join(
        baseline_dir,
        method_dir,
        f"{method_name}_reproduce_checkpoints_channel{channel_cnt}",
    )
    ckpt_dirs = os.listdir(ckpt_root_dir)
    mix_acc_list = []
    for ckpt_dir in ckpt_dirs:
    ...
    ckpt_root_dir = os.path.join(
        baseline_dir,
        method_dir,
        f"{method_name}_filterssim_checkpoints_channel{channel_cnt}",
    )
    ckpt_dirs = os.listdir(ckpt_root_dir)
    filterssim_acc_list = []
    for ckpt_dir in ckpt_dirs:
    ...
    ckpt_root_dir = os.path.join(
        baseline_dir,
        method_dir,
        f"{method_name}_filtertrts_checkpoints_channel{channel_cnt}",
    )
    ckpt_dirs = os.listdir(ckpt_root_dir)
    filtertrts_acc_list = []
    for ckpt_dir in ckpt_dirs:
    ...
    ckpt_root_dir = os.path.join(
        syncheck_dir,
        method_dir,
        f"{method_name}_syncheck_checkpoints_channel{channel_cnt}",
    )
    ckpt_dirs = os.listdir(ckpt_root_dir)
    syncheck_acc_list = []
    for ckpt_dir in ckpt_dirs:
