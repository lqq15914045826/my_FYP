...
def main(args):
    ...
    np.save(os.path.join(args.dataset_dir, 'cycle_target_all_syn_csi.npy'), cycle_target_all_syn_csi)
    np.save(os.path.join(args.dataset_dir, 'cycle_target_all_syn_label.npy'), cycle_target_all_syn_label)
